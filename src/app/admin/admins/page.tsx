        ...
        <div>
          <div className="border-4 border-foreground bg-background shadow-[12px_12px_0_0_currentColor]">
            <div className="border-b-4 border-foreground bg-foreground text-background p-4 flex justify-between items-center">
              ...
              >
                <Database className="w-4 h-4" /> Identity Access Management
                Table
              </h2>
              <span
              ...
              <div className="p-8 overflow-y-auto">
                <form onSubmit={handleCreate} className="space-y-6">
                  ...
                  <div className="pt-8 border-t-4 border-foreground flex justify-end gap-6">
                    ...
                    <button
                      type="submit"
                      className={`flex items-center gap-2 border-4 border-foreground bg-green-500 text-white px-6 py-3 font-bold uppercase tracking-widest shadow-[6px_6px_0_0_var(--foreground)] hover:-translate-y-1 hover:translate-x-1 hover:shadow-[2px_2px_0_0_var(--foreground)] transition-all focus:outline-none focus:ring-4 focus:ring-foreground/20 active:translate-y-1 active:translate-x-1 active:shadow-none flex-1 justify-center ${mono.className}`}
                    >
                      Initialize Operator
                    </button>
                  </div>
