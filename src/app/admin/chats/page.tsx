...
export default function ChatsPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-100px)] border rounded-lg overflow-hidden bg-white shadow-md">
      <RealtimeAlarm />
      {/* Chat List */}
        ...
        <div className="overflow-y-auto flex-1">
          {chats.map(chat => (
            <div 
              ...
              className={`p-4 border-b cursor-pointer hover:bg-blue-50 ${activeChat?.id === chat.id ? 'bg-blue-100' : ''} relative`}
            >
        ...
        {activeChat ? (
          <>
            <div className="p-4 border-b bg-white flex justify-between items-center">
              <div>
                <h2 className="font-bold">Visitor #{activeChat.visitor_id.slice(0, 5)}</h2>
